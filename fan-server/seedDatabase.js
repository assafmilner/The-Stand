...
const sampleMatches = {
  "הפועל תל אביב": [
    { homeTeam: "הפועל תל אביב", awayTeam: "מכבי תל אביב", stadium: "בלומפילד", date: "2025-02-15", time: "20:00" },
    { homeTeam: "הפועל באר שבע", awayTeam: "הפועל תל אביב", stadium: "טרנר", date: "2025-02-22", time: "17:00" },
    { homeTeam: "הפועל תל אביב", awayTeam: "מכבי חיפה", stadium: "בלומפילד", date: "2025-03-01", time: "20:00" },
    { homeTeam: "בית\"ר ירושלים", awayTeam: "הפועל תל אביב", stadium: "טדי", date: "2025-03-08", time: "17:00" }
  ],
  "מכבי תל אביב": [
    { homeTeam: "מכבי תל אביב", awayTeam: "הפועל תל אביב", stadium: "בלומפילד", date: "2025-02-15", time: "20:00" },
    { homeTeam: "מכבי חיפה", awayTeam: "מכבי תל אביב", stadium: "סמי עופר", date: "2025-02-22", time: "17:00" },
    { homeTeam: "מכבי תל אביב", awayTeam: "הפועל באר שבע", stadium: "בלומפילד", date: "2025-03-01", time: "20:00" },
    { homeTeam: "מכבי נתניה", awayTeam: "מכבי תל אביב", stadium: "נתניה", date: "2025-03-08", time: "17:00" }
  ],
  "הפועל באר שבע": [
    { homeTeam: "הפועל באר שבע", awayTeam: "הפועל תל אביב", stadium: "טרנר", date: "2025-02-22", time: "17:00" },
    { homeTeam: "מכבי תל אביב", awayTeam: "הפועל באר שבע", stadium: "בלומפילד", date: "2025-03-01", time: "20:00" },
    { homeTeam: "הפועל באר שבע", awayTeam: "מכבי חיפה", stadium: "טרנר", date: "2025-03-08", time: "17:00" },
    { homeTeam: "הפועל חיפה", awayTeam: "הפועל באר שבע", stadium: "סמי עופר", date: "2025-03-15", time: "20:00" }
  ],
  "מכבי חיפה": [
    { homeTeam: "מכבי חיפה", awayTeam: "מכבי תל אביב", stadium: "סמי עופר", date: "2025-02-22", time: "17:00" },
    { homeTeam: "הפועל תל אביב", awayTeam: "מכבי חיפה", stadium: "בלומפילד", date: "2025-03-01", time: "20:00" },
    { homeTeam: "הפועל באר שבע", awayTeam: "מכבי חיפה", stadium: "טרנר", date: "2025-03-08", time: "17:00" },
    { homeTeam: "מכבי חיפה", awayTeam: "בית\"ר ירושלים", stadium: "סמי עופר", date: "2025-03-15", time: "20:00" }
  ],
  'בית"ר ירושלים': [
    { homeTeam: "בית\"ר ירושלים", awayTeam: "הפועל תל אביב", stadium: "טדי", date: "2025-03-08", time: "17:00" },
    { homeTeam: "מכבי חיפה", awayTeam: "בית\"ר ירושלים", stadium: "סמי עופר", date: "2025-03-15", time: "20:00" },
    { homeTeam: "בית\"ר ירושלים", awayTeam: "הפועל ירושלים", stadium: "טדי", date: "2025-03-22", time: "17:00" },
    { homeTeam: "מכבי נתניה", awayTeam: "בית\"ר ירושלים", stadium: "נתניה", date: "2025-03-29", time: "20:00" }
  ],
  "הפועל חיפה": [
    { homeTeam: "הפועל חיפה", awayTeam: "הפועל באר שבע", stadium: "סמי עופר", date: "2025-03-15", time: "20:00" },
    { homeTeam: "מכבי נתניה", awayTeam: "הפועל חיפה", stadium: "נתניה", date: "2025-03-22", time: "17:00" },
    { homeTeam: "הפועל חיפה", awayTeam: "עירוני קרית שמונה", stadium: "סמי עופר", date: "2025-03-29", time: "20:00" },
    { homeTeam: "הפועל ירושלים", awayTeam: "הפועל חיפה", stadium: "טדי", date: "2025-04-05", time: "17:00" }
  ],
  "מכבי נתניה": [
    { homeTeam: "מכבי נתניה", awayTeam: "מכבי תל אביב", stadium: "נתניה", date: "2025-03-08", time: "17:00" },
    { homeTeam: "מכבי נתניה", awayTeam: "בית\"ר ירושלים", stadium: "נתניה", date: "2025-03-29", time: "20:00" },
    { homeTeam: "מכבי נתניה", awayTeam: "הפועל חיפה", stadium: "נתניה", date: "2025-03-22", time: "17:00" },
    { homeTeam: "עירוני קרית שמונה", awayTeam: "מכבי נתניה", stadium: "קרית שמונה", date: "2025-04-05", time: "20:00" }
  ],
  "עירוני קרית שמונה": [
    { homeTeam: "הפועל חיפה", awayTeam: "עירוני קרית שמונה", stadium: "סמי עופר", date: "2025-03-29", time: "20:00" },
    { homeTeam: "עירוני קרית שמונה", awayTeam: "מכבי נתניה", stadium: "קרית שמונה", date: "2025-04-05", time: "20:00" },
    { homeTeam: "עירוני קרית שמונה", awayTeam: "הפועל פתח תקווה", stadium: "קרית שמונה", date: "2025-04-12", time: "17:00" },
    { homeTeam: "בני יהודה", awayTeam: "עירוני קרית שמונה", stadium: "יהודה", date: "2025-04-19", time: "20:00" }
  ],
  "הפועל פתח תקווה": [
    { homeTeam: "עירוני קרית שמונה", awayTeam: "הפועל פתח תקווה", stadium: "קרית שמונה", date: "2025-04-12", time: "17:00" },
    { homeTeam: "הפועל פתח תקווה", awayTeam: "מכבי פתח תקווה", stadium: "HaMoshava", date: "2025-04-19", time: "20:00" },
    { homeTeam: "בני סכנין", awayTeam: "הפועל פתח תקווה", stadium: "Doha", date: "2025-04-26", time: "17:00" },
    { homeTeam: "הפועל פתח תקווה", awayTeam: "מ.ס. אשדוד", stadium: "HaMoshava", date: "2025-05-03", time: "20:00" }
  ],
  "הפועל ירושלים": [
    { homeTeam: "בית\"ר ירושלים", awayTeam: "הפועל ירושלים", stadium: "טדי", date: "2025-03-22", time: "17:00" },
    { homeTeam: "הפועל ירושלים", awayTeam: "הפועל חיפה", stadium: "טדי", date: "2025-04-05", time: "17:00" },
    { homeTeam: "הפועל ירושלים", awayTeam: "בני יהודה", stadium: "טדי", date: "2025-04-12", time: "20:00" },
    { homeTeam: "מכבי פתח תקווה", awayTeam: "הפועל ירושלים", stadium: "HaMoshava", date: "2025-04-19", time: "17:00" }
  ],
  "בני יהודה": [
    { homeTeam: "בני יהודה", awayTeam: "עירוני קרית שמונה", stadium: "יהודה", date: "2025-04-19", time: "20:00" },
    { homeTeam: "הפועל ירושלים", awayTeam: "בני יהודה", stadium: "טדי", date: "2025-04-12", time: "20:00" },
    { homeTeam: "בני יהודה", awayTeam: "בני סכנין", stadium: "יהודה", date: "2025-04-26", time: "17:00" },
    { homeTeam: "הפועל רמת גן", awayTeam: "בני יהודה", stadium: "רמת גן", date: "2025-05-03", time: "20:00" }
  ],
  "מכבי פתח תקווה": [
    { homeTeam: "הפועל פתח תקווה", awayTeam: "מכבי פתח תקווה", stadium: "HaMoshava", date: "2025-04-19", time: "20:00" },
    { homeTeam: "מכבי פתח תקווה", awayTeam: "הפועל ירושלים", stadium: "HaMoshava", date: "2025-04-19", time: "17:00" },
    { homeTeam: "מכבי פתח תקווה", awayTeam: "מ.ס. אשדוד", stadium: "HaMoshava", date: "2025-04-26", time: "20:00" },
    { homeTeam: "בני סכנין", awayTeam: "מכבי פתח תקווה", stadium: "Doha", date: "2025-05-03", time: "17:00" }
  ],
  "בני סכנין": [
    { homeTeam: "בני סכנין", awayTeam: "הפועל פתח תקווה", stadium: "Doha", date: "2025-04-26", time: "17:00" },
    { homeTeam: "בני יהודה", awayTeam: "בני סכנין", stadium: "יהודה", date: "2025-04-26", time: "17:00" },
    { homeTeam: "בני סכנין", awayTeam: "מכבי פתח תקווה", stadium: "Doha", date: "2025-05-03", time: "17:00" },
    { homeTeam: "הפועל כפר שלם", awayTeam: "בני סכנין", stadium: "כפר שלם", date: "2025-05-10", time: "20:00" }
  ],
  "מ.ס. אשדוד": [
    { homeTeam: "הפועל פתח תקווה", awayTeam: "מ.ס. אשדוד", stadium: "HaMoshava", date: "2025-05-03", time: "20:00" },
    { homeTeam: "מכבי פתח תקווה", awayTeam: "מ.ס. אשדוד", stadium: "HaMoshava", date: "2025-04-26", time: "20:00" },
    { homeTeam: "מ.ס. אשדוד", awayTeam: "הפועל רמת גן", stadium: "יד אליהו", date: "2025-05-10", time: "17:00" },
    { homeTeam: "מ.ס. אשדוד", awayTeam: "הפועל כפר שלם", stadium: "יד אליהו", date: "2025-05-17", time: "20:00" }
  ],
  "הפועל רמת גן": [
    { homeTeam: "הפועל רמת גן", awayTeam: "בני יהודה", stadium: "רמת גן", date: "2025-05-03", time: "20:00" },
    { homeTeam: "מ.ס. אשדוד", awayTeam: "הפועל רמת גן", stadium: "יד אליהו", date: "2025-05-10", time: "17:00" },
    { homeTeam: "הפועל רמת גן", awayTeam: "הפועל כפר שלם", stadium: "רמת גן", date: "2025-05-17", time: "17:00" },
    { homeTeam: "הפועל רמת גן", awayTeam: "הפועל תל אביב", stadium: "רמת גן", date: "2025-05-24", time: "20:00" }
  ],
  "הפועל כפר שלם": [
    { homeTeam: "הפועל כפר שלם", awayTeam: "בני סכנין", stadium: "כפר שלם", date: "2025-05-10", time: "20:00" },
    { homeTeam: "מ.ס. אשדוד", awayTeam: "הפועל כפר שלם", stadium: "יד אליהו", date: "2025-05-17", time: "20:00" },
    { homeTeam: "הפועל רמת גן", awayTeam: "הפועל כפר שלם", stadium: "רמת גן", date: "2025-05-17", time: "17:00" },
    { homeTeam: "הפועל כפר שלם", awayTeam: "מכבי תל אביב", stadium: "כפר שלם", date: "2025-05-24", time: "17:00" }
  ]
};

// Enhanced name arrays
const maleFirstNames = [
  "יוסי", "רועי", "איתי", "מתן", "אדם", "ליאור", "עומר", "שחר", "נדב", "אלעד",
  "עמיר", "רון", "איל", "גל", "תום", "אור", "נועם", "עידו", "זיו", "אריאל",
  "דוד", "משה", "אברהם", "יעקב", "יצחק", "שמואל", "דניאל", "מיכאל", "רפאל", "עזרא",
  "אבי", "בועז", "עודד", "יונתן", "נתן", "שי", "טל", "קורן", "רם", "לי"
];

const femaleFirstNames = [
  "נועה", "שירה", "תמר", "מיכל", "מאיה", "דנה", "אור", "רוני", "טל", "איילת",
  "ליאת", "גל", "שני", "מור", "קרן", "חן", "עדן", "מעיין", "ליה", "שירן",
  "רותם", "יעל", "הדר", "נגה", "סתיו", "אביגיל", "רחל", "לאה", "דינה", "מרים",
  "שרה", "רבקה", "אסתר", "יהודית", "בת שבע", "ליבי", "צביה", "פנינה", "חווה", "נעמי"
];

const lastNames = [
  "כהן", "לוי", "פרץ", "ישראלי", "מלכה", "רוזן", "אביטל", "נחום", "זיו", "ברק",
  "דוד", "משה", "אברהם", "יעקב", "גולדמן", "שמיר", "בן דוד", "גבע", "טל", "מור",
  "אמור", "זהבי", "נחמן", "שלום", "ברוך", "דרור", "אלון", "צבר", "ארז", "כרמל",
  "גלבוע", "הררי", "שדה", "ענבר", "דגן", "רימון", "אתרוג", "זית", "תמר", "ליבנה"
];

const israeliCities = [
  "מרכז", "צפון", "דרום", "ירושלים", "אחר"
];
...
const commentTemplates = [
  ...
  "מסכים איתך מאה אחוז! 💯", "בדיוק מה שחשבתי! 👍", "אין מילים! צודק לחלוטין! ✅",
  "לא יכולתי להגיד את זה יותר טוב! 🎯", "כל מילה במקום! 👏",
  
  // Strong emotions
  "אני בשוק! לא מאמין שזה קרה! 😱", "הלב שלי עדיין דופק! ❤️", "קיבלתי צמרמורת! 🥶",
  "בוכה מרגש! 😭", "לא יכול להפסיק לחייך! 😄", "עדיין לא מעכל את זה! 🤯",
  
  // Praise and admiration
  "איזה מקצוען! כל הכבוד! 👨‍💼", "גאון! פשוט גאון! 🧠", "זה בדיוק מה שהקבוצה צריכה! ⭐",
  "שחקן ברמה עולמית! 🌍", "המאמן הזה יודע מה הוא עושה! 🎯",
  
  // Team spirit and unity
  "יאללה בנים! בואו נתמוך! 💪", "ביחד ננצח! 🤝", "הקבוצה הכי טובה בעולם! 🏆",
  "אנחנו איתכם עד הסוף! ❤️", "זה מה שקוראים רוח קבוצתית! 👥",
  
  // Analysis and discussion
  "המהלך הזה היה גאוני! 🎲", "לא הבנתי את ההחלפה הזאת... 🤔", "אולי היה צריך לשחק יותר הגנתי? 🛡️",
  "הטקטיקה הזאת עבדה מושלם! 📋", "צריך להתחזק בחורף! 💪",
  
  // Excitement for future
  "מחכה כבר למשחק הבא! ⏰", "העונה הזאת תהיה שלנו! 🏆", "אני מרגיש שמשהו גדול מתקרב! 🌟",
  "בואו נמלא את האצטדיון! 🏟️", "הכל עוד לפנינו! 🚀",
  
  // Disagreement and debate
  "לא בטוח שזה הצעד הנכון... 🤨", "יש לי דעה אחרת לגמרי! 💭", "מעניין לשמוע, אבל... 🧐",
  "אולי יש זווית אחרת לראות את זה? 👀", "לא משכנע אותי... 😕",
  
  // Questions and engagement
  "מה אתם חושבים על זה? 🤔", "מישהו יכול להסביר למה? ❓", "איך אתם רואים את המצב? 👁️",
  "מי עוד שם לב לזה? 🕵️", "יש למישהו מידע נוסף על זה? 📰",
  
  // Memories and nostalgia
  "זוכר כמה התרגשתי אז! 😊", "הזמנים הטובים! 📸", "אותו רגש כמו פעם! ❤️",
  "איך הזמן עף! ⏳", "זה מזכיר לי משהו מהעבר... 💭",
  
  // Motivation and encouragement
  "בואו נמשיך לתמוך! 📣", "לא מוותרים! 💪", "יש לנו את הכוח! ⚡",
  "ביחד נעבור את זה! 🤝", "האמונה היא הכל! 🙏"
];

// Reply templates for deeper conversation
const replyTemplates = [
  // Short agreements
  "בדיוק! 💯", "ממש כך! ✅", "אין ספק! 👍", "לגמרי! 🎯",
  "מה שאמרת! 👏", "בול! 🔥", "נכון מאוד! ✔️",
  
  // Elaborations
  "ועוד איך! זה בדיוק מה שחסר לנו! 💪", "נכון, ובנוסף לזה גם... 📝",
  "רואה שאתה מבין בכדורגל! 🧠", "מסכים, אבל חשוב גם... 🤔",
  
  // Emotional responses
  "גם אני התרגשתי! 😍", "נתת לי צמרמורת! 🥶", "אני נפל מהכיסא! 😂",
  "הלב שלי כמעט עצר! 💓", "קיבלתי התכווצות! 😱",
  
  // Questions back
  "ואתה מה חושב על...? 🤔", "איך אתה רואה את זה? 👀",
  "מסכים, אבל מה עם...? 💭", "נכון, ומה אם...? 🎲",
  
  // Disagreements
  "רגע, אני לא מסכים... 🤨", "יש לי דעה קצת אחרת 💬",
  "מבין אותך, אבל... 🧐", "לא בטוח בזה... 😕",
  
  // Adding information
  "ועוד משהו שחשוב... 📌", "דרך אגב, גם... 💡",
  "נכון, ושמעתי גם ש... 👂", "ובאותו הקשר... 🔗",
  
  // Future oriented
  "בואו נראה מה יהיה! 🔮", "מקווה שתהיה צודק! 🙏",
  "נחכה ונראה... ⏳", "הזמן יגיד! ⌛"
];
...
function generateUserName(gender) {
  const firstName = gender === "זכר" ? randomChoice(maleFirstNames) : randomChoice(femaleFirstNames);
...
async function connectDB() {
  try {
    const mongoUrl = process.env.MONGO_URL.includes('<MONGO_PASSWORD>') 
      ? process.env.MONGO_URL.replace('<MONGO_PASSWORD>', process.env.MONGO_PASSWORD)
...
async function clearDatabaseExceptUsers(userIdsToKeep) {
  console.log("🗑️ Clearing DB except users", userIdsToKeep.map(id => id.toString()));

  await User.deleteMany({ _id: { $nin: userIdsToKeep } });
  await Post.deleteMany({ authorId: { $nin: userIdsToKeep } });

  const userPostIds = await Post.find({ authorId: { $in: userIdsToKeep } }).distinct("_id");
...
async function createUsers() {
  ...
  for (const team of teams) {
    ...
    for (let i = 0; i < usersPerTeam; i++) {
      ...
      const profilePicture = gender === "זכר" 
...
async function fetchRealFixtures() {
  ...
  try {
    ...
    try {
      ...
      const ligat_haal = await fixturesService.fetchAllFixtures(4644, '2024-2025', false);
      
      // Fetch Leumit League fixtures (seasonId: 4966) 
      const leumit = await fixturesService.fetchAllFixtures(4966, '2024-2025', false);
      
      allApiFixtures = [
        ...ligat_haal.allFixtures,
        ...leumit.allFixtures
      ];
    ...
    for (let i = 0; i < 4; i++) {
      ...
      if (opponent !== hebrewTeam) {
        ...
        sampleFixtures.push({
          ...
          time: ['17:00', '19:00', '20:00', '20:30'][Math.floor(Math.random() * 4)],
...
async function createComments(users, posts) {
  ...
  for (const post of posts) {
    ...
    const postAuthor = users.find(u => u._id.toString() === post.authorId.toString());
    if (!postAuthor) continue;
    
    const sameTeamUsers = users.filter(u => u.favoriteTeam === postAuthor.favoriteTeam);
    ...
    for (let i = 0; i < commentsCount; i++) {
      ...
      const comment = new Comment({
        ...
        createdAt: new Date(postCreatedAt.getTime() + randomNumber(1, 48) * 60 * 60 * 1000)
      });
        ...
        for (let j = 0; j < repliesCount; j++) {
          ...
          if (replier._id.toString() !== comment.authorId.toString()) {
            const reply = new Comment({
              ...
              createdAt: new Date(comment.createdAt.getTime() + randomNumber(1, 12) * 60 * 60 * 1000)
            });
  ...
  console.log(`✅ Created ${comments.length} comments - ALL from same team users`);
  return comments;
}
...
async function addLikesToPosts(users, posts) {
  ...
  for (let i = 0; i < posts.length; i += batchSize) {
    ...
    for (const post of batch) {
      ...
      const author = users.find(u => u._id.toString() === post.authorId.toString());
      if (!author) continue;
      
      const sameTeamUsers = users.filter(u => u.favoriteTeam === author.favoriteTeam);
...
async function createTicketListings(users) {
  ...
  allFixtures.forEach(fixture => {
    const homeTeamHebrew = fixture.homeTeamHebrew || getHebrewTeamName(fixture.homeTeam);
    const awayTeamHebrew = fixture.awayTeamHebrew || getHebrewTeamName(fixture.awayTeam);
  ...
  for (const user of users) {
    ...
    if (teamFixtures.length === 0) {
      ...
      const futureDate = randomFutureDate(60);
      const opponents = Object.keys(teamNameMapping).filter(t => t !== userTeam);
      const opponent = randomChoice(opponents);
      const isHome = Math.random() > 0.5;
      
      const sampleFixture = {
        id: `sample_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`,
        homeTeam: teamNameMapping[isHome ? userTeam : opponent] || (isHome ? userTeam : opponent),
        awayTeam: teamNameMapping[isHome ? opponent : userTeam] || (isHome ? opponent : userTeam),
    ...
    for (let i = 0; i < ticketsCount; i++) {
      ...
      const isValidMatch = fixture.homeTeamHebrew === userTeam || fixture.awayTeamHebrew === userTeam;
      ...
      const ticket = new TicketListing({
        sellerId: user._id,
        matchId: fixture.id || `match_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`,
        homeTeam: teamNameMapping[fixture.homeTeamHebrew] || fixture.homeTeamHebrew,
        awayTeam: teamNameMapping[fixture.awayTeamHebrew] || fixture.awayTeamHebrew,
  ...
  console.log(`✅ Created ${tickets.length} ticket listings with team-based segregation`);
  return tickets;
}
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log(`   👥 Users: ${users.length} (across ${Object.keys(teamsData).length} teams)`);
    console.log(`   📝 Posts: ${posts.length}`);
    console.log(`   💬 Comments: ${comments.length} (${mainComments.length} main + ${replies.length} replies)`);
