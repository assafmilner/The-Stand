...
const { getCurrentUser, changePassword, updateProfileInfo, uploadProfilePicture, uploadCoverImage, deleteAccount,  getPublicProfile  } = require("../controllers/userController");
